...
public class AdaptationManager extends IntentService {
	...
	public static StringBuffer ResultadoTeste = null;
				...
				while(true){
					...
					if(mCurRuleList.size()>0){
						...
						//[GA-ANALISADOR-COMBINA-BEGIN-Satisfied]
							...
							ResultadoTeste = new StringBuffer();
							ResultadoTeste.append(satisfiedRuleList.get(0).currentProfile.profileName);
							ResultadoTeste.append('@');
							ResultadoTeste.append(satisfiedRuleList.get(0).ruleName);
							ResultadoTeste.append('@');
							ResultadoTeste.append(satisfiedRuleList.get(0).newProfile.profileName);
							ResultadoTeste.append('@');
							ResultadoTeste.append("Volume:" + satisfiedRuleList.get(0).newProfile.ringVolume);
							ResultadoTeste.append(",Vibracall:" + satisfiedRuleList.get(0).newProfile.vibration);
							ResultadoTeste.append(",ModoAviao:" + satisfiedRuleList.get(0).newProfile.airplaneMode);

							SaidaDoCasoDeTeste = new SaidaDoCasoDeTeste();
							SaidaDoCasoDeTeste.setEstadoAtual(satisfiedRuleList.get(0).currentProfile.profileName);
							SaidaDoCasoDeTeste.setNomeDoPredicado(satisfiedRuleList.get(0).ruleName);
							SaidaDoCasoDeTeste.setEstadoNovo(satisfiedRuleList.get(0).newProfile.profileName);
							SaidaDoCasoDeTeste.setVolume(satisfiedRuleList.get(0).newProfile.ringVolume);
							SaidaDoCasoDeTeste.setVibracao(satisfiedRuleList.get(0).newProfile.vibration);
							SaidaDoCasoDeTeste.setModoAviao(satisfiedRuleList.get(0).newProfile.airplaneMode);

							/* Log de contexto para analise  */
							Log.i("Testing-SA-Saida", ResultadoTeste.toString());
							...
							if(candidate.size()==1){
								...
								/* Log de contexto para analise  */
								ResultadoTeste = new StringBuffer();
								ResultadoTeste.append(candidate.get(0).currentProfile.profileName);
								ResultadoTeste.append('@');
								ResultadoTeste.append(candidate.get(0).ruleName);
								ResultadoTeste.append('@');
								ResultadoTeste.append(candidate.get(0).newProfile.profileName);
								ResultadoTeste.append('@');
								ResultadoTeste.append("Volume:" + candidate.get(0).newProfile.ringVolume);
								ResultadoTeste.append(",Vibracall:" + candidate.get(0).newProfile.vibration);
								ResultadoTeste.append(",ModoAviao:" + candidate.get(0).newProfile.airplaneMode);

								SaidaDoCasoDeTeste = new SaidaDoCasoDeTeste();
								SaidaDoCasoDeTeste.setEstadoAtual(candidate.get(0).currentProfile.profileName);
								SaidaDoCasoDeTeste.setNomeDoPredicado(candidate.get(0).ruleName);
								SaidaDoCasoDeTeste.setEstadoNovo(candidate.get(0).newProfile.profileName);
								SaidaDoCasoDeTeste.setVolume(candidate.get(0).newProfile.ringVolume);
								SaidaDoCasoDeTeste.setVibracao(candidate.get(0).newProfile.vibration);
								SaidaDoCasoDeTeste.setModoAviao(candidate.get(0).newProfile.airplaneMode);
...
//				});
	...
	private final IBinder mBinder = new AdaptationManagerBinder();
	@Override
	...
	public class AdaptationManagerBinder extends Binder {

		public AdaptationManager getService() {
			// Return this instance of LocalService so clients can call public methods.
			return AdaptationManager.this;
		}
	}
